...
(напр, "Вокс, погода"). Но иногда это избыточно - например, если мы пишем игру, и команды идут непрерывно.

С версии 4.0 поддерживается установление **контекста**. В контексте
движок:
  * принимает фразы без префикса Вокс (имени ассистента)
...
(нужно, чтобы Вокс не зависала в состоянии, если пользователь ушел)
...
Запустите её с помощью команды "Вокс игра больше меньше"
